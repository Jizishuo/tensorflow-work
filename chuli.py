...
def chuli_alarm(path_dict):
    ...
    alary_all_F.to_csv('alary_all_F.csv', encoding='utf_8_sig', index=False)
    alary_all_L.to_csv('alary_all_L.csv', encoding='utf_8_sig', index=False)
...
def chuli_zhibiao(path_dict):
    ...
    zhibi_1 = pd.read_csv(zhibi_1, encoding='utf_8_sig')
    ...
    zhibi_2 = pd.read_csv(zhibi_2, encoding='utf_8_sig')[all_list_frist]
    ...
    zhibiao_all.rename(columns={'level_0': 'eNodeBid', 'level_1': '发生时间'}, inplace=True)
...
def main():
    ...
    #print(path_dict)
    path_dict = {'history': 'data/1002_history.csv', 'nowday': 'data/1002_nowday.csv', 0: 'data/1002_0.csv', 1: 'data/1002_1.csv'}
    #a, b = chuli_alarm(path_dict)
