...
data1 = pd.read_csv('F:/work/tianhe4location/tianhe4location.csv')
...
zhibiao_flow = zhibiao_grouped['flow'].sum().unstack()
...
result.to_csv('F:/work/tianhe4location/result52127_new.csv')
