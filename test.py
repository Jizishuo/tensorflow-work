# -*- coding: utf-8 -*-
"""
Created on Mon Jun 11 17:32:34 2018
...
full_cellname = pd.read_csv('F:/work/packge/basic_data/cellname_4loc.csv')

cell_net = pd.read_csv('F:/work/packge/basic_data/cell_200net.csv')
cell_net_need = cell_net[['Description', 'CellName']]
cell_net_need.columns = ['net_num', 'cellname']
