# -*- coding: utf-8 -*-
"""
Created on Thu Jul 19 19:37:02 2018
...
full_cellname1 = pd.read_csv('F:/cell_list.csv')
full_cellname1.columns = ['index', 'cellname']
full_cellname = list(full_cellname1['cellname'])
